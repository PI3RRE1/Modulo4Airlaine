          ...
          <div class="row g-2">
            ...
            <div class="mt-3">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal" style="background-color:purple; border: black" >Sair</button>
                                    <button type="submit" class="btn btn-primary" style="background-color:purple; border: black " >Salvar</button>
          </div>
        </form>  
      </section>
