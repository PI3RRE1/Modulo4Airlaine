      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link" href="Clintelist.jsp">Consultar</a>
                           ...
                           <form class="container p-5 reserva" action="Reserva-save">
                               <div class="form-group ">
                                    <label for="data_partida">Data de Reserva</label> <input
                                        type="date" class="form-control" id="data" name="data">
                                </div>
                                <div class="form-group">
                                    <label for="cancelado">cancelado?</label> <input type="text"
                                        class="form-control" id="cancelado" name="cancelado"
                                        placeholder="cancelado">
                                </div>
                                <div class="form-group">
                                    <label for="cliente">ID Cliente</label>
                                    <textarea class="form-control" id="cliente" name="cliente"
                                        placeholder="ID Cliente"></textarea>
                                </div>
                                <div class="mt-3">
